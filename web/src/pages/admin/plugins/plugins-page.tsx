...
const officialApplicationIds = new Set([RUNNINGHUB_PLUGIN_ID, COMFYUI_PLUGIN_ID, EAGLE_PLUGIN_ID, PROMPT_OPTIMIZER_PLUGIN_ID, "portrait-clearance", MEDIA_CONVERSION_PLUGIN_ID, "framescript-video-engine", "mock-video-renderer"]);
    ...
    for (const plugin of listRegisteredPlugins()) {
        ...
        byId.set(plugin.manifest.id, {
            ...
            management: {
                ...
                configurationScope: application ? (plugin.manifest.id === EAGLE_PLUGIN_ID || plugin.manifest.id === RUNNINGHUB_PLUGIN_ID || plugin.manifest.id === COMFYUI_PLUGIN_ID || plugin.manifest.id === "framescript-video-engine" ? "user" : "none") : "system",
            },
        });
    }
